export const projects: [
  {
    ...
    overview: "DIMCPrep is a subscription-based exam preparation platform that helps students prepare for the Diploma in Immediate Medical Care (DIMC). It includes a modern student interface and a powerful admin dashboard for managing exams and users.";
  ...
  },
  {
    ...
    overview: "PAWRADISE is a full-stack pet training appointment booking platform. Pet training centers can offer both group and individual training sessions, while pet owners can book appointments and manage their training schedules.";
