  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-[1100px] mx-auto px-4 sm:px-6 flex flex-col lg:flex-row items-center lg:items-stretch justify-between gap-12 lg:gap-20">
        ...
        <div className="w-full max-w-[340px] relative shrink-0 mx-auto lg:mx-0 flex flex-col">
          ...
          <div className="w-full h-full bg-[#111111]/90 backdrop-blur-xl border border-white/10 rounded-3xl p-6 relative group flex flex-col items-center text-center shadow-2xl">
            ...
            <h3 className="text-emerald-400 font-medium text-sm mb-4">
              Software Engineer
            </h3>
            ...
            <div className="flex items-center justify-center gap-4 mb-7 w-full">
              <Link
                ...
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-all shadow-sm"
              >
                <HugeiconsIcon
                  aria-hidden="true"
            ...
            <div className="w-full flex flex-col gap-3 mt-auto">
              <Link
                href="#contact"
                className="w-full py-3.5 bg-emerald-400 text-black font-bold rounded-xl hover:bg-emerald-300 transition-colors flex items-center justify-center gap-2 text-sm shadow-[0_0_20px_rgba(52,211,153,0.2)]"
              >
                Get in touch <ArrowRight className="w-4 h-4" />
              </Link>
              <button
                onClick={() => setIsPdfModalOpen(true)}
                className="w-full py-3.5 bg-black/50 border border-white/10 text-white font-medium rounded-xl hover:bg-white/5 transition-colors flex items-center justify-center gap-2 text-sm cursor-pointer"
              >
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left mt-10 lg:mt-0">
          ...
          <h1 className="text-[42px] sm:text-5xl md:text-6xl lg:text-[72px] font-extrabold tracking-tight leading-[1.05] mb-8 font-serif">
          ...
          <p className="text-lg md:text-xl text-[#a1a1aa] max-w-[600px] mb-12 leading-relaxed font-medium">
          ...
          {/* Stats Row */}
          <div className="mt-auto w-full grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 border-t border-white/10 pt-10">
            <div className="flex flex-col gap-2">
              <span className="text-4xl md:text-5xl font-serif text-white font-bold">
                2+
              </span>
              <span className="text-[#a1a1aa] text-[10px] md:text-[11px] font-bold tracking-widest uppercase">
                Years Experience
              </span>
            </div>
            <div className="flex flex-col gap-2">
